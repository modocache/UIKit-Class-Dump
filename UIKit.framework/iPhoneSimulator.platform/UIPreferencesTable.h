...
- (void)_animatePiecesOfCell:(id)arg1 isFirstItemInGroup:(BOOL)arg2 isDeletion:(BOOL)arg3 isDestinationRowFrame:(struct CGRect)arg4;
...
- (struct CGRect)frameOfPreferencesCellAtRow:(int)arg1 inGroup:(int)arg2;
...
- (id)_visibleCheckedCellInTableRowRange:(struct _NSRange)arg1;
