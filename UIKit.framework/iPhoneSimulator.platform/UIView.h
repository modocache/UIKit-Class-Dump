...
+ (_Bool)_validateNewFocusCandidate:(id)arg1 fromCurrentFocusItem:(id)arg2 heading:(unsigned long long)arg3;
...
- (_Bool)_shouldChangeFocusedItem:(id)arg1 heading:(unsigned long long)arg2;
- (id)_window;
