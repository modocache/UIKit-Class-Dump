...
@interface UIStatusBarServerThread : NSThread
{
    ...
    CDStruct_24dca785 _statusBarData;
    CDStruct_24dca785 _composedStatusBarData;
    CDStruct_3d5224b0 _overrides;
...
- (void)_postStatusBarOverrideData:(CDStruct_3d5224b0 *)arg1;
...
- (int)_styleOverrides;
- (void)_postStatusBarData:(CDStruct_24dca785 *)arg1 actions:(int)arg2;
- (void)_broadcastStatusBarDataWithActions:(int)arg1;
- (CDStruct_3d5224b0 *)_statusBarOverrideData;
- (CDStruct_24dca785 *)_statusBarData;
