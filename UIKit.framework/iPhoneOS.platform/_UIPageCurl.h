...
- (void)_cancelManualCurlAtLocation:(struct CGPoint)arg1 withSuggestedVelocity:(float)arg2;
...
- (void)_enqueueCurlOfType:(int)arg1 fromLocation:(struct CGPoint)arg2 inDirection:(int)arg3 withView:(id)arg4 revealingView:(id)arg5 completion:(CDUnknownBlockType)arg6;
...
@property(readonly, nonatomic, getter=_isManualPageCurlInProgress) BOOL _manualPageCurlInProgress;
- (void)dealloc;
