...
@interface UIViewController : UIResponder <NSCoding, UIAppearanceContainer>
{
    ...
    CDUnknownBlockType _customNavigationTransitionCompletion;
...
@property(copy, nonatomic) CDUnknownBlockType customNavigationTransitionCompletion; // @synthesize customNavigationTransitionCompletion=_customNavigationTransitionCompletion;
...
- (float)_performCustomNavigationTransitionWithController:(id)arg1 inView:(id)arg2 completion:(CDUnknownBlockType)arg3;
