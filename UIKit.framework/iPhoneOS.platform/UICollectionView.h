...
- (id)_doubleSidedAnimationsForView:(id)arg1 withStartingLayoutAttributes:(id)arg2 endingLayoutAttributes:(id)arg3 withAnimationSetup:(CDUnknownBlockType)arg4 animationCompletion:(CDUnknownBlockType)arg5;
